...
/// Developer preview
/// This is a utility class to help preview SwiftUI views
/// It is not intended to be used in production
class DeveloperPreview {
    
    /// Static instance of the developer preview
    static let instance = DeveloperPreview()
    /// Private initializer to ensure only one instance is ever created
    private init() { }
